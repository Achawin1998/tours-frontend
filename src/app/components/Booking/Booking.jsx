  ...
  return (
    <div className='booking'>
        ...
        <div className='booking__form'>
          ...
          <FormGroup>
                  <input type='text' placeholder={title} id='tourName' value={title} onChange={handleChange}   />
              </FormGroup>
              ...
              <FormGroup className='d-flex align-items-center gap-3'>
                  ...
                  <input type='number' placeholder='Guest' value={booking.guestSize} id='guestSize' onChange={handleChange} required />
              </FormGroup>
          </Form>
        </div>
        ...
        <div className='booking__bottom'>
            ...
            <Button onClick={handleSubmit} className='btn primary__btn w-100 mt-4'>Book now</Button>
        </div>
    </div>
  )
}
