    ...
    <Slider {...settings}>
        <div className='testimonial py-4 px-3 '>
            ...
            <div className='d-flex align-items-center gap-4 mt-3'>
                <Image width={100} height={100} src={ava01} alt="Avatar 1" className='w-25 h-25 rouned-2' /> {/* ใช้ Image จาก next/image และเพิ่ม alt */}
        ...
        <div className='testimonial py-4 px-3'>
           ...
           <div className='d-flex align-items-center gap-4 mt-3'>
                <Image width={100} height={100} src={ava02} alt="Avatar 2" className='w-25 h-25 rouned-2' /> {/* ใช้ Image จาก next/image และเพิ่ม alt */}
        ...
        <div className='testimonial py-4 px-3'>
            ...
            <p>This flight is very good service. I&apos;m not exaggerating. But this is a premium service. Plus the price is not expensive as well.</p> {/* ใช้ &apos; แทน ' */}

            <div className='d-flex align-items-center gap-4 mt-3'>
                <Image width={100} height={100} src={ava03} alt="Avatar 3" className='w-25 h-25 rouned-2' /> {/* ใช้ Image จาก next/image และเพิ่ม alt */}
        ...
        <div className='testimonial py-4 px-3'>
            ...
            <p>To be honest, I didn&apos;t expect anything at first. Book because it&apos;s cheap. But I was really surprised by the service here. It was really good.</p> {/* ใช้ &apos; แทน ' */}

            <div className='d-flex align-items-center gap-4 mt-3'>
                <Image width={100} height={100} src={ava06} alt="Avatar 6" className='w-25 h-25 rouned-2' /> {/* ใช้ Image จาก next/image และเพิ่ม alt */}
        ...
        <div className='testimonial py-4 px-3'>
            ...
            <div className='d-flex align-items-center gap-4 mt-3'>
                <Image width={100} height={100} src={ava04} alt="Avatar 4" className='w-25 h-25 rouned-2' /> {/* ใช้ Image จาก next/image และเพิ่ม alt */}
        ...
        <div className='testimonial py-4 px-3'>
            ...
            <div className='d-flex align-items-center gap-4 mt-3'>
                <Image width={100} height={100} src={ava05} alt="Avatar 5" className='w-25 h-25 rouned-2' /> {/* ใช้ Image จาก next/image และเพิ่ม alt */}
