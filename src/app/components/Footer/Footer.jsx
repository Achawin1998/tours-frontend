        ...
        <div className='footer-container'>
            <Row>
                <Col lg='3'>
                 ...
                 <div className='footer-links'>
                    <div className='social__links d-flex justify-content-center align-items-center gap-4'>
                            ...
                            <span>
                            <Link href={'https://github.com/Achawin1998'} target='_blank'><i className="ri-github-line"></i></Link>
                            </span>
                        </div>  
                  </div> 
                </Col>
                ...
                <Col lg='12' className='text-center pt-5'>
                    <p className='copyright'>Copyright {Year} , design and develop by Achawin Intasit. All rights reserved.</p>
                </Col>
